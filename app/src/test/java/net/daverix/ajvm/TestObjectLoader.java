...
import net.daverix.ajvm.operation.AALoadOperation;
import net.daverix.ajvm.operation.ALoadOperation;
import net.daverix.ajvm.operation.AStoreOperation;
import net.daverix.ajvm.operation.ByteCodeOperation;
import net.daverix.ajvm.operation.DLoadOperation;
import net.daverix.ajvm.operation.DStoreOperation;
import net.daverix.ajvm.operation.DupOperation;
import net.daverix.ajvm.operation.FLoadOperation;
import net.daverix.ajvm.operation.FStoreOperation;
import net.daverix.ajvm.operation.GetStaticOperation;
import net.daverix.ajvm.operation.GotoOperation;
import net.daverix.ajvm.operation.IAddOperation;
import net.daverix.ajvm.operation.IDivOperation;
import net.daverix.ajvm.operation.ILoadOperation;
import net.daverix.ajvm.operation.IMulOperation;
import net.daverix.ajvm.operation.IRemOperation;
import net.daverix.ajvm.operation.IStoreOperation;
import net.daverix.ajvm.operation.ISubOperation;
import net.daverix.ajvm.operation.IfEqOperation;
import net.daverix.ajvm.operation.IndexedALoadOperation;
import net.daverix.ajvm.operation.IndexedAStoreOperation;
import net.daverix.ajvm.operation.IndexedDLoadOperation;
import net.daverix.ajvm.operation.IndexedDStoreOperation;
import net.daverix.ajvm.operation.IndexedFLoadOperation;
import net.daverix.ajvm.operation.IndexedFStoreOperation;
import net.daverix.ajvm.operation.IndexedILoadOperation;
import net.daverix.ajvm.operation.IndexedIStoreOperation;
import net.daverix.ajvm.operation.IndexedLLoadOperation;
import net.daverix.ajvm.operation.IndexedLStoreOperation;
import net.daverix.ajvm.operation.InvokeSpecialOperation;
import net.daverix.ajvm.operation.InvokeStaticOperation;
import net.daverix.ajvm.operation.InvokeVirtualOperation;
import net.daverix.ajvm.operation.L2IOperation;
import net.daverix.ajvm.operation.LDCOperation;
import net.daverix.ajvm.operation.LLoadOperation;
import net.daverix.ajvm.operation.LStoreOperation;
import net.daverix.ajvm.operation.NewOperation;
import net.daverix.ajvm.operation.NoOperation;
import net.daverix.ajvm.operation.PushConstOperation;
import net.daverix.ajvm.operation.TableSwitchOperation;
