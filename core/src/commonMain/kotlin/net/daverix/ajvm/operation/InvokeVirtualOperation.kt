...
class InvokeVirtualOperation(private val constantPool: ConstantPool) : ByteCodeOperation {
    ...
    override fun execute(
        ...
        if (instance is VirtualObject) {
            ...
            throw UnsupportedOperationException("don't know how to handle popped value \"$instance\" for method \"$methodName$methodDescriptor\" with args [${methodArgs.joinToString()}]")
        }
    }
}
