...
sealed class Operation {
    ...
    data class Ldc(val constant: Any?) : Operation()
    data class Ldc2(val constant: Any) : Operation()
    ...
    data class GetStatic(val className: String, val fieldName: String) : Operation()
    data class PutStatic(val className: String, val fieldName: String) : Operation()
    data class GetField(val className: String, val fieldName: String) : Operation()
    data class PutField(val className: String, val fieldName: String) : Operation()
    data class InvokeVirtual(val className: String, val methodName: String, val descriptor: String) : Operation()
    data class InvokeSpecial(val className: String, val methodName: String, val descriptor: String) : Operation()
    data class InvokeStatic(val className: String, val methodName: String, val descriptor: String) : Operation()
    data class InvokeInterface(val className: String, val methodName: String, val descriptor: String) : Operation()
    data class InvokeDynamic(val className: String, val methodName: String, val descriptor: String) : Operation()
    data class New(val className: String) : Operation()
    data class NewArray(val type: Int) : Operation()
    data class ANewArray(val className: String) : Operation()
    object ArrayLength : Operation()
    object AThrow : Operation()

    data class CheckCast(val className: String) : Operation()
    data class InstanceOf(val className: String) : Operation()
    object MonitorEnter : Operation()
    object MonitorExit : Operation()

    data class MultiANewArray(val className: String, val dimensions: Int) : Operation()
    data class IfNull(
            override val byteCodeIndex: Int,
            override val offset: Int
    ) : Operation(), OffsetOperation
